...
class YOLOXEAExp(BaseExp):
    ...
    def get_model(self):
        from yolox.models.yolo_attention_head import YOLOXAttentionHead
        from yolox.models.yolox_ea import YOLOXEA
        ...
        if getattr(self, "model", None) is None:
            ...
            head = YOLOXAttentionHead(self.num_classes, self.width, strides=head_strides, in_channels=head_in_channels, act=self.act)
            self.model = YOLOXEA(backbone, head)
